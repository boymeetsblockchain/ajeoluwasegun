export const profile = {
	...
	intro: [
		...
		"Right now I wear two hats. As Solutions Architect at TJDND IT Solutions, I oversee technical architecture and delivery across multiple client products including TaxSprings (a Nigerian tax platform with PAYE/CIT compliance), WakaNest (a multi-vendor travel and lifestyle marketplace), and TechFrontline. I own each end-to-end from schema design through deployment. As Lead Developer at Swiftxend Courier, I'm building a real-time logistics tracking platform from the ground up, covering live location updates, delivery status, and dispatch workflows.",
